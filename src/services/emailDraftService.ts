  ...
  while (index < lines.length) {
    ...
    if (heading) {
      ...
      if (level === 1) {
        ...
        html.push(`<h2 style="margin:22px 0 10px;padding:8px 10px;border:1px solid #dbe6f3;border-radius:8px;background:#f8fbff;color:#172033;font-size:17px;line-height:1.35;font-weight:800">${title}</h2>`);
      } else {
